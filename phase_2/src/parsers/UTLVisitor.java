...
public interface UTLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link UTLParser#numericValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNumericValue(UTLParser.NumericValueContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link UTLParser#specialFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecialFunction(UTLParser.SpecialFunctionContext ctx);
	/**
	 * Visit a parse tree produced by {@link UTLParser#specialVariable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecialVariable(UTLParser.SpecialVariableContext ctx);
	/**
	 * Visit a parse tree produced by {@link UTLParser#specialMethod}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecialMethod(UTLParser.SpecialMethodContext ctx);
	/**
